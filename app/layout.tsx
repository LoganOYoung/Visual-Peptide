...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${GeistSans.variable} ${GeistMono.variable} bg-slate-50 text-slate-900`}>
      <body className="flex min-h-screen flex-col overflow-x-hidden bg-slate-50 font-sans text-slate-900 antialiased">
        {GA_ID && (
          <>
            <Script
